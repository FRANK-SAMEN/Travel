...
const ImageTourisme = ({
  ...
  return (
    <div>
      <div
        className="h-[224px] flex flex-col justify-between rounded-md bg-no-repeat bg-cover p-4"
        ...
        <div className="flex items-stretch justify-between space-x-4 z-10">
          <div className="text-white font-medium">
            ...
            <div className="font-bold">
              {price}XAF<span className="font-medium">/pers</span>
            </div>
          </div>
          <div>
            <div className="bg-blue-800/60 rounded-full p-2">
              {/* Ici, tu peux insérer l'icône SVG que tu as fournie */}
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
              ...
              >
                <path d="M255.55 22.36c-30.93 0-56 25.07-56 56 0 30.927 25.07 56 56 56 30.927 0 56-25.073 56-56 0-30.93-25.073-56-56-56zM105.067 144.47c-3.047.028-6.012.55-8.748 1.536..."></path>
              </svg>
            </div>
          </div>
        </div>
