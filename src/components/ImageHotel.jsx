...
const ImageHotel = ({ hotelName, location, price, ImageSrc }) => {
  return (
    <div>
      <div className="hidden md:block  relative block w-74 h-46 bg-white rounded-t-md rounded-b-none shadow-lg hover:shadow-xl transition text-blue-800">
        <img
          src={ImageSrc}
          alt="Image 1"
      ...
      {/*mobile*/}
      <div className="block md:hidden   relative block w-74 h-46 bg-white rounded-t-md rounded-b-none  shadow-lg hover:shadow-xl transition text-blue-800">
        <img
          src={ImageSrc}
          alt="Image 1"
          className="w-full h-[160px] rounded-t-md rounded-b-none"
        ...
        <div className="bg-white flex items-stretch flex flex-col space-y-6 ">
          <p className="mx-6 text-[#001F3F]">
            <strong>{hotelName}</strong>
            <br />
            <span>{location}</span>
